<template>
  <div>
    ...
    <div class="mt-4">
      <h2 class="font-bold pt-2 pb-1">
        {{ $t("nav.slogan") }}
      </h2>
      <a href="mailto:contact@foxwallet.com" class="block pb-2 text-xs text-gray-500 border-b border-gray-200">
        {{ $t("nav.contactUs") }}
      </a>
      <p class="pb-12 mt-2 text-xs text-gray-500">
        {{ $t("nav.copyRight") }}
      </p>
    </div>
  </div>
